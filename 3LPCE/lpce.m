...
% AX = B 
% RHS = (2/(solver.dt)).*A *[Sol.rhoPrev ; Sol.uaPrev; Sol.vaPrev; Sol.paPrev] + Q  - (1 - 2*pmc.alpha).*A*acoustic.v;
% LHS = (2/(solver.dt)).*A + B;

RHS = ((1/(solver.dt)).*A - B./2)*[Sol.rhoPrev ; Sol.uaPrev; Sol.vaPrev; Sol.paPrev] + Q  - (1 - 2*pmc.alpha).*A*acoustic.v;
LHS = (1/(solver.dt)).*A + B./2;
...
% Update acoustic.v 
acoustic.v = (2/solver.dt).*([rho ; ua ; va;pa] - [Sol.rhoPrev ; Sol.uaPrev; Sol.vaPrev; Sol.paPrev]) - acoustic.v;
